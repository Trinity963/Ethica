...
def _generate_stub(mod_name, tools):
    ...
    lines = [
        ...
        "# Architect: Victory  |  ⟁Σ∿∞",
        f"# {'=' * 58}",
        "# Edit the functions below to implement your tools.",
        "# Each function takes one string argument and returns a string.",
        f"# {'=' * 58}",
        "",
    ]
    for t in tools:
...
def _patch_engine(tools):
    ...
    original = content  # noqa — reserved for rollback on patch failure
