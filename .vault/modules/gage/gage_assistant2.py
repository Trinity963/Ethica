#streamlit run gage_assistant2.py
#run inside VSCode 
...
if "code_assistant" not in st.session_state:
    st.session_state["code_assistant"] = pipeline(
        "text-generation",
        model="/home/nine9/models/Llama-2-7b-hf",
        local_files_only=True
    )


code_assistant = st.session_state["code_assistant"]
...
if user_input:
    ...
    response = code_assistant(user_input, max_length=300)[0]["generated_text"]
